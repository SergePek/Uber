...
public class DriverHomeActivity extends AppCompatActivity {
    ...
    private void showDialogUpLoad() {
        ...
        builder.setTitle("Измененить аватар")
                .setMessage("Вы действительно хотите изменить аватар?")
                ...
                .setPositiveButton("Изменить", (dialog, which) -> {
                    if (imageUri != null){
                        ...
                        avatarFolder.putFile(imageUri)
                            ...
                            waitingDialog.setMessage(new StringBuilder("Загрузка: ").append(progress).append("%"));
                        });
